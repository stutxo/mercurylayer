...
use self::bip448::{
    ...
    replace_bip448_scan_cache_on, require_selected_bip448_wallet_coin_on, row_to_bip448_attempt,
    row_to_bip448_binding, row_to_bip448_intent, transfer_message_matches_record_and_history,
    validate_selected_bip448_coin, Bip448WalletCoinRequirement, BIP448_ATTEMPT_COLUMNS,
    BIP448_BINDING_COLUMNS, BIP448_INTENT_COLUMNS,
};
pub(crate) use self::bip448::{
    ...
    upsert_bip448_scanned_outpoint, Bip448InitialAcceptanceRecovery,
};
pub use self::bip448::{
    begin_bip448_mutation_guard, delete_bip448_pending_deposit_signing,
    delete_bip448_pending_transfer_signing, delete_bip448_transfer_msgs,
    get_bip448_funding_binding, get_bip448_package_attempt, get_bip448_pending_deposit_signing,
    ...
    insert_or_update_bip448_transfer_msg, list_bip448_funding_bindings,
    list_bip448_transfer_intents, list_bip448_withdrawal_attempts,
    persist_bip448_initial_acceptance, set_bip448_package_attempt_status,
    update_bip448_pending_deposit_server_public_nonce,
    update_bip448_pending_transfer_server_public_nonce, Bip448FeeInputRecord, Bip448MutationGuard,
    Bip448PackageAttempt, Bip448PackageAttemptStatus, Bip448PendingDepositSigning,
    Bip448ScanCursor, BIP448_FEE_RESERVATION_TTL_SECONDS,
};
#[cfg(test)]
use self::bip448::{
    clear_bip448_scan_state, upsert_bip448_statechain_record, Bip448BeginImmediateTestHook,
...
mod tests {
    ...
    use bitcoin::{absolute, Address, Network, OutPoint};
